...
String.prototype.colorRgb = function () {
  // 16进制颜色值的正则
  var reg = /^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$/; // 把颜色值变成小写S
...
var line = function line(obj) {
  ...
  var fn = function (obj) {
    return function () {
      var stackline_datas = _chartDataFormate["default"].FormateGroupData(data, 'line', obj.stack, obj.yAxisIndex);
      ...
      _lodash["default"].forEach(series, function (item, index) {
        // var itemStyle={
        //     color: _self.colors[index],
        // }
        var symbol = 'circle'; // item.itemStyle = itemStyle;
      ...
      _lodash["default"].assign(_self.chartCommonOption.legend, legend);
...
var lineArea = function lineArea(obj) {
  var _self = this;
