...
var pieLabel = function pieLabel(obj) {
  ...
  var fn = function (obj) {
    return function () {
      var pie_datas = _chartDataFormate["default"].FormateNOGroupData(data);
      ...
      var pieOptions = _lodash["default"].merge(pieLabelCommonOption, option);
...
var pieLabel1 = function pieLabel1(obj) {
  ...
  var fn = function (obj) {
    return function () {
      ...
      var pieOptions = _lodash["default"].merge(pieLabelCommonOption1, option);
...
var pieLegend = function pieLegend(obj) {
  ...
  var fn = function (obj) {
    return function () {
      ...
      var pieOptions = _lodash["default"].merge(pieLegendCommonOption, option);
...
var pieRingLabel = function pieRingLabel(obj) {
  ...
  var fn = function (obj) {
    return function () {
      ...
      var pieOptions = _lodash["default"].merge(pieRingLabelCommonOption, option);
...
var pieRingLegend = function pieRingLegend(obj) {
  ...
  var fn = function (obj) {
    return function () {
      ...
      var pieOptions = _lodash["default"].merge(pieRingLegendCommonOption, option);
