...
exports.bezierCurveUtil = exports.progressUtil = void 0;
      ...
      value: function calculateCurvePerNode(nodeArr, t) {
        ...
        if (nodeArr.length) {
          ...
          nodeArr.forEach(function (item, idx) {
            ...
            x += item[0] * offset;
            y += item[1] * offset; // console.log(`${x},${y}`);
          });
          return [x, y];
        }
...
var progressUtil = window.ProgressUtil;
exports.progressUtil = progressUtil;
var bezierCurveUtil = window.BezierCurveUtil;
exports.bezierCurveUtil = bezierCurveUtil;