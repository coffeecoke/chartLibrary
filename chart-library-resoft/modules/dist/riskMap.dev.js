...
define(['jquery', 'echarts', 'modules/chartDataFormate'], function ($, echarts, chartDataFormate) {
  ...
  var renderMap = function renderMap(riskMap_datas, map) {
      ...
      tooltip: {
        ...
        formatter: function formatter(params) {
          if (params.seriesType === "effectScatter" || params.seriesType === "scatter") {
            return '<div class="tooltip">' + '<p class="name" style="word-wrap:break-word;">' + params.name + '</p>' + '<p>风险等级 <span>' + parseInt(params.data.value[2] / 10) + '</span>级</p>' + '</div>';
          }
        }
      },
      toolbox: {
  ...
  var riskMap = function riskMap(obj) {
    var _self = this;
